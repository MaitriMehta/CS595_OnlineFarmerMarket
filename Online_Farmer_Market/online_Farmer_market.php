...
<!--       Indicators -->
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <div class="container">
            <div class="carousel-caption" style="background-image: url(images/fresh-local-produce.jpg);width: 1300px;height: 400px;background-repeat: no-repeat;   ">
              ...
              <p><a class="btn btn-lg btn-primary" href="SignUp.php" data-tarrole="button">Sign up today</a></p>
            </div>
          </div>
        </div>
        <div class="item">
